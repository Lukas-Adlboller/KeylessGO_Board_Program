...
CredentialEntry::CredentialEntry(ILI9341* displayDriver, Point pos, uint16_t bColor, uint16_t fColor, string text)
  : GUIElement(displayDriver, pos, Point(285, 37), Point(0, 0), 0, bColor, fColor, text)
{
...
{
  return sendToPCButton->Clicked(x, y);
}
